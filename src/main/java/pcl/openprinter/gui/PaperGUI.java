...
public class PaperGUI extends GuiScreen {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        this.currPage = 0;
        // OpenPrinter.logger.info(stack.getTagCompound().getTagList("pages",
        // Constants.NBT.TAG_COMPOUND).getStringTagAt(0));
        ...
        if (PaperGUI.isBook) {
                ...
                if (parts.length > 1) {
                    ...
                    if (alignment.equalsIgnoreCase("center")) {
                        mc.fontRenderer.drawString(
                                parts[0],
                                width / 2 - mc.fontRenderer.getStringWidth(parts[0]) / 2,
                                height / 2 - offset,
                                color);
                    } else {
            ...
            if (stack.hasTagCompound()) {
                if (stack.stackTagCompound.getDouble("version") == 2.0) {
                    // drawCenteredString(mc.fontRenderer, stack.stackTagCompound.getString("pageTitle"), width / 2,
                ...
                mc.fontRenderer.drawString(
                        ...
                        width / 2 - mc.fontRenderer.getStringWidth("This page intentionally left blank.") / 2,
                        height / 2 - offset,
                        0x000000);
            }
        }
